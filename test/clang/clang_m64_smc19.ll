; ModuleID = 'smc19.c'
source_filename = "smc19.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@code = common dso_local global [8 x i8] zeroinitializer, align 1
...
define dso_local i32 @main() #0 {
  ...
  %2 = call i32 @getMemoryPermission(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @code, i32 0, i32 0))
  call void (...) bitcast ([8 x i8]* @code to void (...)*)()
  %3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i64 0, i64 0))
  ret i32 0
}
