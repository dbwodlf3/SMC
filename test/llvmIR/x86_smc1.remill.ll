...
15:                                               ; preds = %35, %3
  %16 = phi i32 [ 1, %3 ], [ %36, %35 ]
  %17 = phi i32 [ %11, %3 ], [ %38, %35 ]
  %18 = phi %struct.Memory* [ %2, %3 ], [ %37, %35 ]
  %19 = tail call i32 @__remill_read_memory_32(%struct.Memory* %18, i32 0) #3
  %20 = icmp eq i32 %16, %19
  %21 = select i1 %20, i32 22, i32 5
  %22 = add i32 %21, %17
  br i1 %20, label %23, label %35

23:                                               ; preds = %15
  %24 = getelementptr inbounds %union.anon.1, %union.anon.1* %5, i32 0, i32 0
  %25 = getelementptr inbounds %struct.State, %struct.State* %0, i32 0, i32 2, i32 3
  ...
  store i8 0, i8* %12, align 1, !tbaa !4
  ...
  store i8 0, i8* %13, align 1, !tbaa !22
  %28 = add i32 %22, 9
  ...
  store i32 4, i32* %31, align 16, !tbaa !24
  %32 = tail call %struct.Memory* @__remill_async_hyper_call(%struct.State* nonnull %0, i32 %28, %struct.Memory* %18)
  %33 = load i32, i32* %10, align 4
  %34 = tail call %struct.Memory* @__remill_missing_block(%struct.State* nonnull %0, i32 %33, %struct.Memory* %18)
  ret %struct.Memory* %34

35:                                               ; preds = %15
  %36 = add i32 %16, 1
  store i32 %36, i32* %7, align 4, !tbaa !0
  %37 = tail call %struct.Memory* @__remill_write_memory_8(%struct.Memory* %18, i32 27, i8 zeroext 1) #3
  %38 = add i32 %22, -5
  br label %15
}
...
; Function Attrs: noduplicate noinline nounwind optnone readnone
declare dso_local %struct.Memory* @__remill_write_memory_8(%struct.Memory*, i32, i8 zeroext) #1
...
!23 = !{!2, !2, i64 0}
!24 = !{!25, !26, i64 0}
!25 = !{!"_ZTS9ArchState", !26, i64 0, !1, i64 4, !2, i64 8}
!26 = !{!"_ZTSN14AsyncHyperCall4NameE", !2, i64 0}