...
define dso_local i32 @functionTestSecond(i32 %foo, i32 %bar) {
  entry:
...
define dso_local i32 @main() {
  ...
  next:
    ...
    %call_ins2 = call i32 @functionTestSecond(i32 1, i32 %load_ins3)
    %call_ins3 = call i32 @functionTestSecond(i32 %load_ins3, i32 2)

    %ret_alloca = alloca i8
